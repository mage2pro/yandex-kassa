The extension integrates your Magento 2 store with the **[Yandex.Kassa](https://checkout.yandex.com)** (as known as Yandex.Checkout, Яндекс.Касса) payment service (Russia).  
Yandex.Kassa has **[30% market share (2017)](http://www.slideshare.net/SergeyUlankin/marc-presentation-2017)** among the payment service providers in Russia by the number of websites using it.
...
## Support
- [The extension's **forum** branch](https://mage2.pro/c/extensions/yandex-kassa).
...
- [Subscribe](https://mage2.pro/t/2540) to the extension's [forum branch](https://mage2.pro/c/extensions/yandex-kassa).
